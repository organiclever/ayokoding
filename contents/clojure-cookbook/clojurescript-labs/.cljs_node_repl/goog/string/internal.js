...
goog.string.internal.htmlEscape = function (
  ...
  if (opt_isLikelyToContainHtmlChars) {
    str = str
      .replace(goog.string.internal.AMP_RE_, '\x26amp;')
      .replace(goog.string.internal.LT_RE_, '\x26lt;')
      .replace(goog.string.internal.GT_RE_, '\x26gt;')
      .replace(goog.string.internal.QUOT_RE_, '\x26quot;')
      .replace(goog.string.internal.SINGLE_QUOTE_RE_, '\x26#39;')
      .replace(goog.string.internal.NULL_RE_, '\x26#0;');
    return str;
  } else {
