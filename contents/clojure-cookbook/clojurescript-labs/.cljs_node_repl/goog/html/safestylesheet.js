/*TRANSPILED*/ goog.loadModule(function (exports) {
  'use strict'; /*
...
*/
  ...
  class SafeStyleSheet {
    ...
    static createRule(selector, style) {
      ...
      const selectorToCheck = selector.replace(
        /('|")((?!\1)[^\r\n\f\\]|\\[\s\S])*\1/g,
        ''
      );
      if (!/^[-_a-zA-Z0-9#.:* ,>+~[\]()=^$|]+$/.test(selectorToCheck)) {
        throw new Error(
          'Selector allows only [-_a-zA-Z0-9#.:* ,\x3e+~[\\]()\x3d^$|] and ' +
            'strings, got: ' +
            selector
        );
      }
    ...
    static unwrap(safeStyleSheet) {
      if (
        safeStyleSheet instanceof SafeStyleSheet &&
