...
goog.addDependency(
  'vec/mat3_test.js',
  ['goog.vec.Mat3Test'],
  ['goog.vec.Mat3', 'goog.testing.testSuite', 'goog.vec'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/float32array_test.js',
  ['goog.vec.Float32ArrayTest'],
  ['goog.vec.Float32Array', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'vec/vec2_test.js',
  ['goog.vec.Vec2Test'],
  ['goog.vec.Vec2', 'goog.testing.testSuite', 'goog.vec'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'vec/mat3f_test.js',
  ['goog.vec.mat3fTest'],
  ['goog.vec.mat3f', 'goog.testing.testSuite', 'goog.vec'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/mat4.js',
...
goog.addDependency(
  'vec/vec4_test.js',
  ['goog.vec.Vec4Test'],
  ['goog.vec.Vec4', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/vec2d.js',
...
goog.addDependency(
  'vec/float64array_test.js',
  ['goog.vec.Float64ArrayTest'],
  ['goog.vec.Float64Array', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/vec3d.js',
...
goog.addDependency(
  'vec/vec3f_test.js',
  ['goog.vec.vec3fTest'],
  ['goog.testing.testSuite', 'goog.vec', 'goog.vec.vec3f'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/mat4d_test.js',
...
goog.addDependency(
  'vec/vec2d_test.js',
  ['goog.vec.vec2dTest'],
  ['goog.testing.testSuite', 'goog.vec', 'goog.vec.vec2d'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/ray_test.js',
  ['goog.vec.RayTest'],
  ['goog.vec.Ray', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/vec3d_test.js',
  ['goog.vec.vec3dTest'],
  ['goog.testing.testSuite', 'goog.vec', 'goog.vec.vec3d'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/mat3d.js',
  ['goog.vec.mat3d', 'goog.vec.mat3d.Type'],
  ['goog.vec', 'goog.vec.vec3d.Type'],
  { lang: 'es6' }
);
goog.addDependency(
  'vec/mat4f.js',
...
goog.addDependency(
  ...
  ['goog.vec', 'goog.vec.vec3f.Type'],
  { lang: 'es6' }
);
goog.addDependency(
  'vec/vec4f_test.js',
  ['goog.vec.vec4fTest'],
  ['goog.testing.testSuite', 'goog.vec.vec4f'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/mat3d_test.js',
  ['goog.vec.mat3dTest'],
  ['goog.vec.mat3d', 'goog.testing.testSuite', 'goog.vec'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/vec4d.js',
...
goog.addDependency(
  'vec/vec2f_test.js',
  ['goog.vec.vec2fTest'],
  ['goog.testing.testSuite', 'goog.vec', 'goog.vec.vec2f'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/vec4d_test.js',
  ['goog.vec.vec4dTest'],
  ['goog.testing.testSuite', 'goog.vec.vec4d'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'vec/vec3_test.js',
  ['goog.vec.Vec3Test'],
  ['goog.vec.Vec3', 'goog.testing.testSuite', 'goog.vec'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'async/delay.js',
...
goog.addDependency(
  ...
  ['goog.async.WorkQueue', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'async/promises_test.js',
  ['goog.async.promisesTest'],
  ['goog.async.promises', 'goog.testing.testSuite'],
  { lang: 'es8', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.async.FreeList', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.async.Delay', 'goog.testing.MockClock', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'async/run_next_tick_test.js',
  ['goog.async.runNextTickTest'],
  [
    'goog.testing.MockClock',
    'goog.dispose',
    'goog.testing.recordFunction',
...
goog.addDependency('async/promises.js', ['goog.async.promises'], [], {
  lang: 'es6',
  module: 'goog',
});
goog.addDependency(
...
goog.addDependency(
  'async/run_test.js',
  ['goog.async.runTest'],
  ['goog.testing.recordFunction', 'goog.async.run', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.async.FreeList', 'goog.asserts'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'async/debouncer.js',
...
goog.addDependency(
  ...
  [
    ...
    'goog.async.Throttle',
    'goog.testing.testSuite',
    'goog.testing.objects',
  ],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'async/legacy_throttle.js',
  ['goog.Throttle'],
  ['goog.async.Throttle'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.format.InternationalizedEmailAddress', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'format/jsonprettyprinter_test.js',
  ['goog.format.JsonPrettyPrinterTest'],
  ['goog.format.JsonPrettyPrinter', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.format.EmailAddress'],
  ['goog.i18n.bidi', 'goog.object', 'goog.string'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  [
    ...
    'goog.testing.PropertyReplacer',
    'goog.date.relative',
    'goog.i18n.relativeDateTimeSymbols',
    'goog.testing.testSuite',
  ],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.asserts', 'goog.i18n.DateTimeSymbols', 'goog.string'],
  { lang: 'es6' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.dom.TagName', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'dom/asserts.js',
...
goog.addDependency(
  ...
  ['goog.dom', 'goog.dom.NodeType', 'goog.dom.TagIterator', 'goog.userAgent'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.dom.Range', 'goog.dom', 'goog.testing.testSuite', 'goog.userAgent'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'dom/tags_test.js',
  ['goog.dom.tagsTest'],
  ['goog.dom.tags', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'dom/classlist.js',
...
goog.addDependency(
  'dom/dom_compile_test.js',
  ['goog.dom.DomCompileTest'],
  ['goog.dom.TagName', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'dom/dataset.js',
  ['goog.dom.dataset'],
  ['goog.labs.userAgent.browser', 'goog.string', 'goog.userAgent.product'],
  {}
);
goog.addDependency(
  'dom/browserfeature_test.js',
  ['goog.dom.BrowserFeatureTest'],
  ['goog.dom.BrowserFeature', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'dom/textassert_test.js',
  ['goog.dom.textassert_test'],
  ['goog.testing.testSuite', 'goog.dom.textAssert', 'goog.userAgent'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'dom/safe.js',
...
goog.addDependency(
  ...
  ['goog.dom.AbstractMultiRange'],
  ['goog.array', 'goog.dom', 'goog.dom.AbstractRange', 'goog.dom.TextRange'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  'dom/uri_test.js',
  ['goog.dom.uriTest'],
  ['goog.userAgent.product', 'goog.testing.testSuite', 'goog.dom.uri'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'dom/vendor_test.js',
...
goog.addDependency(
  'dom/selection.js',
  ['goog.dom.selection'],
  ['goog.dom.InputType', 'goog.string'],
  {}
);
goog.addDependency(
  'dom/element.js',
...
goog.addDependency(
  'dom/savedrange.js',
  ['goog.dom.AbstractSavedCaretRange', 'goog.dom.SavedRange'],
...
goog.addDependency(
  ...
  ['goog.dom.dataset', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'promise/nativeresolver.js',
  ['goog.promise.NativeResolver'],
  [],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'promise/nativeresolver_test.js',
  ['goog.promise.nativeResolverTest'],
  ['goog.promise.NativeResolver', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'singleton/singleton_test.js',
  ['goog.singletontest'],
  ['goog.singleton', 'goog.testing.testSuite', 'goog.testing.singleton'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'singleton/singleton.js',
  ['goog.singleton'],
  ['goog.reflect', 'goog.asserts'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'locale/timezonedetection.js',
  ['goog.locale.timeZoneDetection'],
  ['goog.asserts', 'goog.locale.TimeZoneFingerprint'],
  { lang: 'es6' }
);
goog.addDependency(
  'locale/timezonelist_test.js',
  ['goog.locale.TimeZoneListTest'],
  ['goog.locale', 'goog.testing.testSuite', 'goog.locale.timezonelist'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'locale/countrylanguagenames_test.js',
  ['goog.locale.countryLanguageNamesTest'],
  ['goog.locale', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.testing.testSuite', 'goog.locale.timeZoneDetection'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'graphics/solidfill_test.js',
  ['goog.graphics.SolidFillTest'],
  ['goog.graphics.SolidFill', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.graphics.ext.coordinates', 'goog.graphics', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.array', 'goog.graphics.AffineTransform', 'goog.math'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  'labs/dom/pagevisibilityevent.js',
  ['goog.labs.dom.PageVisibilityEvent'],
  [
    'goog.events.Event',
    'goog.events.EventType',
...
goog.addDependency(
  'labs/dom/pagevisibilitystate.js',
  ['goog.labs.dom.PageVisibilityState'],
  [],
  { module: 'goog' }
);
...
goog.addDependency(
  'labs/mock/timeoutmode.js',
  ['goog.labs.mock.timeout', 'goog.labs.mock.timeout.TimeoutMode'],
  [],
  { lang: 'es6' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.testing.testSuite', 'goog.labs.mock.verification'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'labs/mock/mock.js',
  ...
  [
    ...
    'goog.functions',
    'goog.labs.mock.timeout',
    'goog.labs.mock.timeout.TimeoutMode',
    'goog.labs.mock.verification',
    'goog.labs.mock.verification.BaseVerificationMode',
    'goog.labs.mock.verification.VerificationMode',
    'goog.object',
...
goog.addDependency(
  ...
  ['goog.labs.testing.logicmatcher'],
...
goog.addDependency(
  ...
  ['goog.labs.testing.Environment', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'labs/testing/objectmatcher.js',
  ['goog.labs.testing.objectmatcher'],
...
goog.addDependency(
  ...
  [
    'goog.labs.testing.decoratormatcher',
    'goog.labs.testing.dictionarymatcher',
    'goog.labs.testing.logicmatcher',
    'goog.labs.testing.numbermatcher',
    'goog.labs.testing.objectmatcher',
    'goog.labs.testing.stringmatcher',
  ],
  {}
...
goog.addDependency(
  'labs/useragent/testutil.js',
  ['goog.labs.userAgent.testUtil'],
...
goog.addDependency(
  ...
  ['goog.string.internal', 'goog.labs.userAgent.util'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'labs/useragent/test_agentdata.js',
  ['goog.labs.userAgent.testAgentData'],
  ['goog.array', 'goog.debug.deepFreeze'],
  { lang: 'es9', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'labs/useragent/extra.js',
  ['goog.labs.userAgent.extra'],
  ['goog.labs.userAgent.platform'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  ...
  ['goog.labs.userAgent.engine'],
  ['goog.array', 'goog.string.internal', 'goog.labs.userAgent.util'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'labs/useragent/test_agentdata_test.js',
  ['goog.labs.userAgent.testAgentDataTest'],
  ['goog.testing.testSuite', 'goog.labs.userAgent.testAgentData'],
  { lang: 'es8', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'labs/useragent/extra_test.js',
  ['goog.labs.userAgent.extraTest'],
  [
    'goog.testing.PropertyReplacer',
    'goog.labs.userAgent.browser',
    'goog.labs.userAgent.extra',
...
goog.addDependency(
  ...
  ['goog.testing.testSuite', 'goog.labs.events.touch'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.labs.structs.Multimap', 'goog.testing.testSuite', 'goog.userAgent'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.net.WebChannel', 'goog.net.WebChannel.Options'],
  [
    'goog.events',
    'goog.events.Event',
    'goog.events.Listenable',
...
goog.addDependency(
  'labs/net/webchannel/environment_test.js',
  ['goog.labs.net.webChannel.EnvironmentTest'],
  [
...
goog.addDependency(
  'labs/net/webchannel/testing/fakewebchannel.js',
  ['goog.labs.net.webChannel.testing.FakeWebChannel'],
  ['goog.events.EventTarget', 'goog.array', 'goog.testing.asserts'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'labs/net/webchannel/environment.js',
  ['goog.labs.net.webChannel.environment'],
  ['goog.userAgent'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.labs.net.webChannel.WireV8', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.labs.net.webChannel.Wire', 'goog.labs.net.webChannel.Wire.QueuedMap'],
  ['goog.collections.maps'],
  { lang: 'es6' }
);
goog.addDependency(
...
goog.addDependency('demos/tree/testdata.js', [], [], { lang: 'es6' });
goog.addDependency(
...
goog.addDependency('demos/graphics/tigerdata.js', [], [], { lang: 'es6' });
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.proto2.Descriptor', 'goog.proto2.Message', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.asserts', 'goog.object', 'goog.string'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  'streams/full_native_impl_test.js',
  ['goog.streams.fullNativeImplTest'],
  [
    'goog.testing.testSuite',
    'goog.streams.fullTestCases',
    'goog.streams.fullNativeImpl',
  ],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'streams/full_native_impl.js',
  ['goog.streams.fullNativeImpl'],
  ['goog.streams.fullTypes', 'goog.streams.liteNativeImpl'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'streams/full_impl_test.js',
  ['goog.streams.fullImplTest'],
  [
    'goog.testing.testSuite',
    'goog.streams.fullTestCases',
    'goog.streams.fullImpl',
  ],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  ...
  [
    'goog.streams.fullImpl',
    'goog.streams.fullNativeImpl',
    'goog.streams.fullTypes',
    'goog.streams.defines',
  ],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'streams/lite_test_cases.js',
  ['goog.streams.liteTestCases'],
  ['goog.streams.liteTypes', 'goog.testing.jsunit'],
  { lang: 'es8', module: 'goog' }
);
goog.addDependency(
  'streams/full_test_cases.js',
  ['goog.streams.fullTestCases'],
  [
    'goog.testing.recordFunction',
    'goog.streams.fullTypes',
...
goog.addDependency(
  'streams/lite_native_impl.js',
  ['goog.streams.liteNativeImpl'],
  ['goog.streams.liteTypes'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'streams/lite.js',
...
goog.addDependency(
  'streams/lite_impl.js',
  ['goog.streams.liteImpl'],
  ['goog.promise.NativeResolver', 'goog.streams.liteTypes', 'goog.asserts'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'streams/full_types.js',
  ['goog.streams.fullTypes'],
  ['goog.streams.liteTypes'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'streams/lite_native_impl_test.js',
  ['goog.streams.liteNativeImplTest'],
  [
    'goog.testing.testSuite',
    'goog.streams.liteTestCases',
    'goog.streams.liteNativeImpl',
...
goog.addDependency(
  'streams/lite_impl_test.js',
  ['goog.streams.liteImplTest'],
  [
    'goog.testing.testSuite',
    'goog.streams.liteTestCases',
    'goog.streams.liteImpl',
...
goog.addDependency(
  ...
  ['goog.testing.PseudoRandom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'testing/asynctestcase_noasync_test.js',
  ['goog.testing.AsyncTestCaseSyncTest'],
  ['goog.testing.AsyncTestCase', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'testing/dom.js',
...
goog.addDependency(
  ...
  ['goog.testing.Mock', 'goog.testing.MockControl', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.testing.StrictMock'],
  ['goog.array', 'goog.asserts', 'goog.testing.Mock'],
  { lang: 'es5' }
);
goog.addDependency(
  'testing/mockrange_test.js',
  ['goog.testing.MockRangeTest'],
  ['goog.testing.MockRange', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.testing.MockStorage', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['proto2.TestAllTypes', 'goog.testing.proto2', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.Promise', 'goog.promise.Resolver', 'goog.testing.asserts'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.asserts', 'goog.dom', 'goog.dom.classlist', 'goog.testing.asserts'],
  { lang: 'es6' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.dom', 'goog.testing.ui.style', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'testing/csp_test.js',
  [],
  ['goog.testing.TestCase', 'goog.testing.asserts', 'goog.testing.jsunit'],
  { lang: 'es8' }
);
goog.addDependency(
  'testing/objects_test.js',
  ['goog.testing.objects_test'],
  ['goog.testing.asserts', 'goog.testing.testSuite', 'goog.testing.objects'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.testing.fs.Blob', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'testing/fs/blob.js',
...
goog.addDependency(
  ...
  ['goog.testing.fsTest'],
  ['goog.testing.fs.Blob', 'goog.testing.fs', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  [
    ...
    'goog.dom.TagName',
    'goog.object',
    'goog.testing.CspViolationObserver',
    'goog.testing.JsUnitException',
    'goog.testing.asserts',
    'goog.url',
  ],
...
goog.addDependency(
  'testing/testsuite_test.js',
  ['goog.testing.testSuiteTest'],
  ['goog.testing.TestCase', 'goog.testing.asserts', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'testing/singleton_test.js',
  ['goog.testing.singletonTest'],
  ['goog.testing.asserts', 'goog.testing.singleton', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.events.EventTarget', 'goog.testing.MockControl'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.asserts', 'goog.testing.TestCase', 'goog.testing.asserts'],
  {}
);
goog.addDependency(
  'testing/strictmock_test.js',
  ['goog.testing.StrictMockTest'],
  ['goog.testing.StrictMock', 'goog.testing.testSuite'],
  { lang: 'es8', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.testing.MockRandom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'testing/cspviolationobserver.js',
  ['goog.testing.CspViolationObserver'],
  [],
  { lang: 'es6' }
);
...
goog.addDependency(
  'testing/assertionfailure.js',
  ['goog.testing.safe.assertionFailure'],
  ['goog.asserts', 'goog.testing.asserts'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.Thenable', 'goog.array', 'goog.async.Deferred', 'goog.math'],
  { lang: 'es6' }
);
goog.addDependency(
...
goog.addDependency(
  'testing/testrunner_test.js',
  ['goog.testing.TestRunnerTest'],
  [
    'goog.testing.TestCase',
    'goog.testing.TestRunner',
    'goog.testing.asserts',
...
goog.addDependency(
  'log/logbuffer_test.js',
  ['goog.log.LogBufferTest'],
  ['goog.log.Level', 'goog.log.LogBuffer', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'log/log_test.js',
  ['goog.logTest'],
  ['goog.log.Level', 'goog.log', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'log/log.js',
  ...
  ['goog.asserts', 'goog.debug'],
  { lang: 'es6' }
);
goog.addDependency(
  'proto/serializer_test.js',
  ['goog.protoTest'],
  ['goog.proto', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'proto/proto.js',
...
goog.addDependency(
  'math/paths_test.js',
  ['goog.math.pathsTest'],
  ['goog.math.Coordinate', 'goog.math.paths', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/path_test.js',
  ['goog.math.PathTest'],
  ['goog.math.AffineTransform', 'goog.math.Path', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/coordinate3_test.js',
  ['goog.math.Coordinate3Test'],
  ['goog.math.Coordinate3', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/paths.js',
...
goog.addDependency(
  'math/size_test.js',
  ['goog.math.SizeTest'],
  ['goog.math.Size', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'math/box_test.js',
  ['goog.math.BoxTest'],
  ['goog.math.Box', 'goog.math.Coordinate', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'math/vec2_test.js',
  ['goog.math.Vec2Test'],
  ['goog.math.Vec2', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'math/tdma_test.js',
  ['goog.math.tdmaTest'],
  ['goog.math.tdma', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/line.js',
...
goog.addDependency(
  ...
  ['goog.math.Integer', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/line_test.js',
  ['goog.math.LineTest'],
  ['goog.math.Coordinate', 'goog.math.Line', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/range_test.js',
  ['goog.math.RangeTest'],
  ['goog.math.Range', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/vec2.js',
...
goog.addDependency(
  'math/math_test.js',
  ['goog.mathTest'],
  ['goog.math', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.math.interpolator.Spline1', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.math.interpolator.Pchip1', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.math.interpolator.Linear1', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.array', 'goog.math', 'goog.math.AffineTransform'],
  {}
);
goog.addDependency(
  'math/matrix_test.js',
  ['goog.math.MatrixTest'],
  ['goog.math.Matrix', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/integer.js',
...
goog.addDependency(
  ...
  ['goog.math.Coordinate', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.math.ExponentialBackoff', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/long_test.js',
  ['goog.math.LongTest'],
  ['goog.math.Long', 'goog.asserts', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'math/vec3_test.js',
  ['goog.math.Vec3Test'],
  ['goog.math.Coordinate3', 'goog.math.Vec3', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.ui.tree.TreeControl', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'ui/palette_test.js',
...
goog.addDependency(
  ...
  ['goog.object', 'goog.ui.registry', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'ui/ac/richremotearraymatcher_test.js',
  ['goog.ui.ac.RichRemoteArrayMatcherTest'],
  [
    'goog.testing.mockmatchers.ArgumentMatcher',
    'goog.testing.MockControl',
    'goog.testing.net.XhrIo',
...
goog.addDependency(
  ...
  ['goog.ui.ac.ArrayMatcher', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.ui.decorate', 'goog.ui.registry', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.ui.RangeModel', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'ui/roundedpanel.js',
...
goog.addDependency(
  'ui/componentutil_test.js',
  ['goog.ui.ComponentUtilTest'],
  [
    'goog.ui.Component',
...
goog.addDependency(
  ...
  ['goog.ui.BidiInput', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'ui/registry.js',
  ['goog.ui.registry'],
  ['goog.asserts', 'goog.dom.classlist', 'goog.object'],
  {}
);
goog.addDependency(
  'ui/menurenderer.js',
...
goog.addDependency(
  'ui/synthetickeyboardevent.js',
  ['goog.ui.SyntheticKeyboardEvent'],
  ['goog.events.Event', 'goog.ui.KeyboardEventData'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  'ui/map_test.js',
  ['goog.ui.MapTest'],
  ['goog.ui.Map', 'goog.structs', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'ui/keyboardeventdata.js',
...
goog.addDependency(
  ...
  ['goog.ui.CharCounter', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.ui.ServerChart', 'goog.Uri', 'goog.events', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'ui/tabpane_test.js',
  ['goog.ui.TabPaneTest'],
  ['goog.ui.TabPane', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.ui.media.YoutubeModel', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'ui/media/mediamodel_test.js',
  ['goog.ui.media.MediaModelTest'],
  ['goog.ui.media.MediaModel', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'ui/media/youtube.js',
...
goog.addDependency(
  ...
  ['goog.ui.emoji.SpriteInfo', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.ui.emoji.PopupEmojiPicker', 'goog.dom', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'iter/es6_test.js',
  ['goog.iter.es6Test'],
  ['goog.testing.testSuite', 'goog.iter.es6', 'goog.iter'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'iter/iter.js',
  ...
  ['goog.array', 'goog.asserts', 'goog.debug', 'goog.functions', 'goog.math'],
  { lang: 'es6' }
);
goog.addDependency(
  'iter/es6.js',
  ['goog.iter.es6'],
  ['goog.iter.Iterable', 'goog.iter.Iterator', 'goog.iter.StopIteration'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'iter/iter_test.js',
...
goog.addDependency(
  'fs/error.js',
  ['goog.fs.DOMErrorLike', 'goog.fs.Error', 'goog.fs.Error.ErrorCode'],
  ['goog.asserts', 'goog.debug.Error', 'goog.object', 'goog.string'],
  { lang: 'es6' }
);
...
goog.addDependency(
  'fs/url_test.js',
  ['goog.urlTest'],
  ['goog.testing.PropertyReplacer', 'goog.testing.testSuite', 'goog.fs.url'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'fs/fs.js',
  ['goog.fs'],
  ['goog.async.Deferred', 'goog.fs.Error', 'goog.fs.FileSystemImpl'],
  { lang: 'es6' }
);
goog.addDependency(
  'fs/filereader.js',
...
goog.addDependency(
  ...
  ['goog.Disposable'],
  ['goog.disposable.IDisposable', 'goog.dispose', 'goog.disposeAll'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.Disposable', 'goog.log.Level', 'goog.log'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.messaging.LoggerClient'],
  ['goog.Disposable', 'goog.debug', 'goog.log'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.userAgent.adobeReader', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.userAgent.jscript', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'loader/activemodulemanager.js',
  ['goog.loader.activeModuleManager'],
  ['goog.loader.AbstractModuleManager', 'goog.asserts'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'loader/abstractmodulemanager.js',
  [
...
goog.addDependency(
  ...
  ['goog.string.path', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.string.format', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'string/newlines_test.js',
  ['goog.string.newlinesTest'],
  ['goog.string.newlines', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.string.Const', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'string/string.js',
...
goog.addDependency(
  ...
  ['goog.string.StringBuffer', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'collections/maps_test.js',
  ['goog.collections.mapsTest'],
  [
    'goog.structs.Map',
    'goog.iter',
    'goog.collections.maps',
...
goog.addDependency(
  'collections/iters_test.js',
  ['goog.collections.iters.iterableTest'],
  [
...
goog.addDependency(
  'collections/sets_test.js',
  ['goog.collections.setsTest'],
  [
    'goog.structs.Set',
    'goog.iter',
    'goog.collections.sets',
...
goog.addDependency(
  'i18n/nativelocaledigits.js',
  ['goog.i18n.NativeLocaleDigits'],
  [],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'i18n/ordinalrules_test.js',
  ['goog.i18n.ordinalRulesTest'],
  [
...
goog.addDependency(
  'i18n/bidi_test.js',
  ['goog.i18n.bidiTest'],
  ['goog.i18n.bidi.Dir', 'goog.i18n.bidi', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'i18n/relativedatetimeformat_test.js',
  ['goog.i18n.RelativeDateTimeFormatTest'],
  [
    'goog.i18n.LocaleFeature',
    ...
    'goog.i18n.RelativeDateTimeFormat',
    'goog.i18n.relativeDateTimeSymbols',
    'goog.i18n.relativeDateTimeSymbolsExt',
    'goog.testing.testSuite',
  ],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'i18n/numberformatsymbolstype.js',
  ['goog.i18n.NumberFormatSymbolsType'],
  [],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'i18n/dateintervalsymbols.js',
  ['goog.i18n.dateIntervalSymbols'],
  [],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'i18n/relativedatetimesymbolsext.js',
  ['goog.i18n.relativeDateTimeSymbolsExt'],
  ['goog.i18n.relativeDateTimeSymbols'],
  { lang: 'es5', module: 'goog' }
);
goog.addDependency(
  'i18n/dateintervalsymbolsext.js',
...
goog.addDependency(
  ...
  ['goog.i18n.CharListDecompressor', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  ...
  [
    ...
    'goog.i18n.CompactNumberFormatSymbols_ceb_PH',
    ...
    'goog.i18n.CompactNumberFormatSymbols_doi_IN',
    ...
    'goog.i18n.CompactNumberFormatSymbols_en_AE',
    ...
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_BF',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_CM',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_GH',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_GM',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_GN',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_GW',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_LR',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_MR',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_NE',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_NG',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_SL',
    'goog.i18n.CompactNumberFormatSymbols_ff_Latn_SN',
    ...
    'goog.i18n.CompactNumberFormatSymbols_ga_GB',
    ...
    'goog.i18n.CompactNumberFormatSymbols_mai_IN',
    ...
    'goog.i18n.CompactNumberFormatSymbols_mni_Beng',
    'goog.i18n.CompactNumberFormatSymbols_mni_Beng_IN',
    ...
    'goog.i18n.CompactNumberFormatSymbols_pcm_NG',
    ...
    'goog.i18n.CompactNumberFormatSymbols_ps_PK',
    ...
    'goog.i18n.CompactNumberFormatSymbols_sa_IN',
    ...
    'goog.i18n.CompactNumberFormatSymbols_sat_Olck',
    'goog.i18n.CompactNumberFormatSymbols_sat_Olck_IN',
    ...
    'goog.i18n.CompactNumberFormatSymbols_sd_Arab',
    'goog.i18n.CompactNumberFormatSymbols_sd_Arab_PK',
    ...
    'goog.i18n.CompactNumberFormatSymbols_su_Latn',
    'goog.i18n.CompactNumberFormatSymbols_su_Latn_ID',
...
goog.addDependency(
  ...
  ['goog.testing.testSuite', 'goog.i18n.uCharNames'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'i18n/relativedatetimesymbols.js',
  ['goog.i18n.relativeDateTimeSymbols'],
  [],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'i18n/relativedatetimeformat.js',
  ['goog.i18n.RelativeDateTimeFormat'],
  [
    'goog.i18n.LocaleFeature',
    'goog.i18n.MessageFormat',
...
goog.addDependency(
  'i18n/dateintervalformat_test.js',
  ['goog.i18n.DateIntervalFormatTest'],
  [
    'goog.i18n.DateIntervalFormat',
    'goog.date.DateRange',
    'goog.date.DateTime',
    ...
    'goog.date.Interval',
    'goog.i18n.TimeZone',
    'goog.i18n.dateIntervalPatterns',
    'goog.i18n.dateIntervalSymbols',
    'goog.object',
    'goog.testing.testSuite',
  ],
...
goog.addDependency(
  ...
  [
    ...
    'goog.i18n.DateTimeSymbols_ceb_PH',
    ...
    'goog.i18n.DateTimeSymbols_doi_IN',
    ...
    'goog.i18n.DateTimeSymbols_ff_Latn',
    'goog.i18n.DateTimeSymbols_ff_Latn_BF',
    'goog.i18n.DateTimeSymbols_ff_Latn_CM',
    'goog.i18n.DateTimeSymbols_ff_Latn_GH',
    'goog.i18n.DateTimeSymbols_ff_Latn_GM',
    'goog.i18n.DateTimeSymbols_ff_Latn_GN',
    'goog.i18n.DateTimeSymbols_ff_Latn_GW',
    'goog.i18n.DateTimeSymbols_ff_Latn_LR',
    'goog.i18n.DateTimeSymbols_ff_Latn_MR',
    'goog.i18n.DateTimeSymbols_ff_Latn_NE',
    'goog.i18n.DateTimeSymbols_ff_Latn_NG',
    'goog.i18n.DateTimeSymbols_ff_Latn_SL',
    'goog.i18n.DateTimeSymbols_ff_Latn_SN',
    ...
    'goog.i18n.DateTimeSymbols_ga_GB',
    ...
    'goog.i18n.DateTimeSymbols_mai_IN',
    ...
    'goog.i18n.DateTimeSymbols_pcm_NG',
    ...
    'goog.i18n.DateTimeSymbols_sa_IN',
    ...
    'goog.i18n.DateTimeSymbols_sat_Olck',
    'goog.i18n.DateTimeSymbols_sat_Olck_IN',
    'goog.i18n.DateTimeSymbols_sbp',
    'goog.i18n.DateTimeSymbols_sbp_TZ',
    'goog.i18n.DateTimeSymbols_sd',
    'goog.i18n.DateTimeSymbols_sd_Arab',
    'goog.i18n.DateTimeSymbols_sd_Arab_PK',
    ...
    'goog.i18n.DateTimeSymbols_su_Latn',
    'goog.i18n.DateTimeSymbols_su_Latn_ID',
...
goog.addDependency(
  ...
  [
    ...
    'goog.i18n.DateTimePatterns_ceb_PH',
    ...
    'goog.i18n.DateTimePatterns_ckb_Arab',
    'goog.i18n.DateTimePatterns_ckb_Arab_IQ',
    ...
    'goog.i18n.DateTimePatterns_doi_IN',
    ...
    'goog.i18n.DateTimePatterns_eo_001',
    ...
    'goog.i18n.DateTimePatterns_ff_Latn',
    'goog.i18n.DateTimePatterns_ff_Latn_BF',
    'goog.i18n.DateTimePatterns_ff_Latn_CM',
    'goog.i18n.DateTimePatterns_ff_Latn_GH',
    'goog.i18n.DateTimePatterns_ff_Latn_GM',
    'goog.i18n.DateTimePatterns_ff_Latn_GN',
    'goog.i18n.DateTimePatterns_ff_Latn_GW',
    'goog.i18n.DateTimePatterns_ff_Latn_LR',
    'goog.i18n.DateTimePatterns_ff_Latn_MR',
    'goog.i18n.DateTimePatterns_ff_Latn_NE',
    'goog.i18n.DateTimePatterns_ff_Latn_NG',
    'goog.i18n.DateTimePatterns_ff_Latn_SL',
    'goog.i18n.DateTimePatterns_ff_Latn_SN',
    ...
    'goog.i18n.DateTimePatterns_ga_GB',
    ...
    'goog.i18n.DateTimePatterns_mai_IN',
    ...
    'goog.i18n.DateTimePatterns_mni_Beng',
    ...
    'goog.i18n.DateTimePatterns_pcm_NG',
    ...
    'goog.i18n.DateTimePatterns_sa_IN',
    ...
    'goog.i18n.DateTimePatterns_sat_Olck',
    'goog.i18n.DateTimePatterns_sat_Olck_IN',
    'goog.i18n.DateTimePatterns_sbp',
    'goog.i18n.DateTimePatterns_sbp_TZ',
    'goog.i18n.DateTimePatterns_sd',
    'goog.i18n.DateTimePatterns_sd_Arab',
    'goog.i18n.DateTimePatterns_sd_Arab_PK',
...
goog.addDependency(
  'i18n/localefeature_test.js',
  ['goog.i18n.LocaleFeatureTest'],
  ['goog.i18n.LocaleFeature', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.i18n.GraphemeBreak', 'goog.testing.testSuite', 'goog.i18n.uChar'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'i18n/pluralrules.js',
...
goog.addDependency(
  ...
  ['goog.asserts', 'goog.i18n.uChar', 'goog.structs.InversionMap'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.i18n.TimeZone', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'i18n/datetimepatternstype.js',
  ['goog.i18n.DateTimePatternsType'],
  [],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'i18n/dateintervalpatterns.js',
  ['goog.i18n.dateIntervalPatterns'],
  ['goog.i18n.dateIntervalSymbols'],
  { module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.i18n.mime.encode', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'i18n/uchar_test.js',
  ['goog.i18n.uCharTest'],
  ['goog.testing.testSuite', 'goog.i18n.uChar'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'i18n/dateintervalpatternsext.js',
  ['goog.i18n.dateIntervalPatternsExt'],
  ['goog.i18n.dateIntervalPatterns'],
  { module: 'goog' }
);
goog.addDependency(
  ...
  [
    ...
    'goog.i18n.NumberFormatSymbols_ceb_PH',
    ...
    'goog.i18n.NumberFormatSymbols_ckb_Arab_u_nu_latn',
    ...
    'goog.i18n.NumberFormatSymbols_ff_Latn',
    ...
    'goog.i18n.NumberFormatSymbols_ks_Arab_u_nu_latn',
    ...
    'goog.i18n.NumberFormatSymbols_mai_IN',
    ...
    'goog.i18n.NumberFormatSymbols_mni_Beng',
    'goog.i18n.NumberFormatSymbols_mni_Beng_IN',
    'goog.i18n.NumberFormatSymbols_mni_Beng_IN_u_nu_latn',
    'goog.i18n.NumberFormatSymbols_mni_Beng_u_nu_latn',
    ...
    'goog.i18n.NumberFormatSymbols_pcm_NG',
    ...
    'goog.i18n.NumberFormatSymbols_sa_IN',
    'goog.i18n.NumberFormatSymbols_sa_IN_u_nu_latn',
    ...
    'goog.i18n.NumberFormatSymbols_sat_Olck',
    'goog.i18n.NumberFormatSymbols_sat_Olck_IN',
    'goog.i18n.NumberFormatSymbols_sat_Olck_IN_u_nu_latn',
    'goog.i18n.NumberFormatSymbols_sat_Olck_u_nu_latn',
    ...
    'goog.i18n.NumberFormatSymbols_sd_Arab',
    'goog.i18n.NumberFormatSymbols_sd_Arab_PK',
    'goog.i18n.NumberFormatSymbols_sd_Arab_PK_u_nu_latn',
    'goog.i18n.NumberFormatSymbols_sd_Arab_u_nu_latn',
    ...
    'goog.i18n.NumberFormatSymbols_su_Latn',
    'goog.i18n.NumberFormatSymbols_su_Latn_ID',
  ...
  ['goog.i18n.NumberFormatSymbols', 'goog.i18n.NumberFormatSymbols_u_nu_latn'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.pubsub.TopicId', 'goog.pubsub.TypedPubSub', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'pubsub/pubsub_test.js',
  ['goog.pubsub.PubSubTest'],
  ['goog.testing.MockClock', 'goog.pubsub.PubSub', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.fx.DragDropGroup', 'goog.events', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'fx/easing_test.js',
  ['goog.fx.easingTest'],
  ['goog.fx.easing', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.style.cursor', 'goog.testing.testSuite', 'goog.userAgent'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'style/cursor.js',
...
goog.addDependency(
  ...
  ['goog.dom', 'goog.style', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'style/transform.js',
...
goog.addDependency(
  'uri/uri_test.js',
  ['goog.UriTest'],
  ['goog.Uri', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'uri/utils_test.js',
  ['goog.uri.utilsTest'],
  ['goog.functions', 'goog.string', 'goog.testing.testSuite', 'goog.uri.utils'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'debug/tracer.js',
  ['goog.debug.StopTraceDetail', 'goog.debug.Trace'],
  [
    'goog.array',
    'goog.asserts',
    'goog.debug',
...
goog.addDependency(
  'debug/deepfreeze_test.js',
  ['goog.deepFreezeTest'],
  ['goog.asserts', 'goog.testing.testSuite', 'goog.debug.deepFreeze'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'debug/error_test.js',
...
goog.addDependency(
  'debug/console.js',
  ['goog.debug.Console'],
  ['goog.debug.TextFormatter', 'goog.log'],
  {}
);
goog.addDependency(
  'debug/formatter.js',
...
goog.addDependency(
  ...
  ['goog.debug', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.debug.DevCss', 'goog.style', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'debug/debug_test.js',
  ['goog.debugTest'],
  ['goog.debug', 'goog.debug.errorcontext', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'debug/errorcontext_test.js',
  ['goog.debug.errorcontextTest'],
  ['goog.debug.errorcontext', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'debug/debugwindow_test.js',
  ['goog.debug.DebugWindowTest'],
  ['goog.debug.DebugWindow', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'debug/debug.js',
  ['goog.debug'],
  ['goog.array', 'goog.debug.errorcontext'],
  {}
);
goog.addDependency(
  'debug/deepfreeze.js',
  ['goog.debug.deepFreeze'],
  ['goog.debug'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'asserts/dom.js',
  ['goog.asserts.dom'],
  ['goog.dom.TagName', 'goog.asserts', 'goog.dom.element'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'asserts/asserts.js',
...
goog.addDependency(
  ...
  ['goog.events.Listenable', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.events.BrowserFeature', 'goog.userAgent'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  'events/eventtype_test.js',
  ['goog.events.EventTypeTest'],
  [
    'goog.events.BrowserFeature',
    'goog.events.EventType',
    'goog.events.PointerFallbackEventType',
...
goog.addDependency(
  ...
  ['goog.memoizeTest'],
  ['goog.memoize', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.json.NativeJsonProcessor', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'json/hybrid.js',
...
goog.addDependency(
  'json/json_test.js',
  ['goog.jsonTest'],
  ['goog.functions', 'goog.json', 'goog.testing.testSuite', 'goog.userAgent'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.array', 'goog.dom', 'goog.dom.TagName', 'goog.dom.safe'],
  { lang: 'es6' }
);
goog.addDependency(
  'cssom/cssom_test.js',
...
goog.addDependency(
  'storage/storagetester.js',
  ['goog.storage.storageTester'],
  ['goog.storage.Storage', 'goog.structs.Map', 'goog.testing.asserts'],
  { lang: 'es6' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.storage.mechanism.mechanismfactory', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.structs.CircularBuffer', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'structs/quadtree_test.js',
  ['goog.structs.QuadTreeTest'],
  ['goog.structs.QuadTree', 'goog.structs', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.structs.Heap', 'goog.structs', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'structs/map.js',
...
goog.addDependency(
  ...
  ['goog.structs.AvlTree', 'goog.array', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'structs/quadtree.js',
...
goog.addDependency(
  ...
  ['goog.structs.TreeNode', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.structs.Set', 'goog.iter', 'goog.structs', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.structs.Collection', 'goog.asserts'],
  { module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.structs.AvlTree', 'goog.structs.Set', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.structs.PriorityQueue', 'goog.structs', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'structs/map_test.js',
  ['goog.structs.MapTest'],
  ['goog.structs.Map', 'goog.iter', 'goog.structs', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'structs/structs.js',
...
goog.addDependency(
  ...
  ['goog.structs.InversionMap', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'structs/queue_test.js',
  ['goog.structs.QueueTest'],
  ['goog.structs.Queue', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'structs/queue.js',
...
goog.addDependency(
  ...
  ['goog.json', 'goog.log', 'goog.log.Logger'],
  { lang: 'es6' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  [
    ...
    'goog.net.browserchannelinternal.hooks',
    'goog.net.browserchannelinternal.stats',
    'goog.net.tmpnetwork',
    'goog.object',
    'goog.string',
    'goog.structs',
...
goog.addDependency(
  ...
  [
    ...
    'goog.testing.testSuite',
    'goog.net.streams.xhrStreamReader',
    'goog.net.streams.streamParsers',
  ],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.net.streams.streamFactory'],
  [
    'goog.asserts',
    'goog.net.streams.xhrNodeReadableStream',
    'goog.net.streams.xhrStreamReader',
...
goog.addDependency(
  'net/streams/pbjsonstreamparser.js',
  ['goog.net.streams.PbJsonStreamParser'],
  [
    'goog.net.streams.JsonStreamParser',
    'goog.net.streams.StreamParser',
...
goog.addDependency(
  'net/streams/pbjsonstreamparser_test.js',
  ['goog.net.streams.PbJsonStreamParserTest'],
  [
    'goog.net.streams.PbJsonStreamParser',
    'goog.object',
    'goog.testing.testSuite',
...
goog.addDependency(
  ...
  ['goog.net.streams.JsonStreamParser'],
  ['goog.asserts', 'goog.net.streams.StreamParser', 'goog.net.streams.utils'],
  { lang: 'es6' }
);
...
goog.addDependency(
  ...
  ['goog.net.NetworkTester'],
  ['goog.Timer', 'goog.Uri', 'goog.dom.safe', 'goog.log'],
  {}
);
goog.addDependency(
  'net/jsonp.js',
  ['goog.net.Jsonp'],
  ['goog.html.TrustedResourceUrl', 'goog.net.jsloader', 'goog.object'],
  { lang: 'es6' }
);
...
goog.addDependency(
  'net/rpc/httpcors.js',
  ['goog.net.rpc.HttpCors'],
  ['goog.Uri', 'goog.object', 'goog.string', 'goog.uri.utils'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'net/rpc/httpcors_test.js',
  ['goog.net.rpc.HttpCorsTest'],
  ['goog.Uri', 'goog.net.rpc.HttpCors', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'net/browserchannelexecutionhooks.js',
  ['goog.net.browserchannelinternal.hooks'],
  [],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency('net/cookies.js', ['goog.net.Cookies'], ['goog.string'], {
  lang: 'es6',
});
...
goog.addDependency(
  'net/tmpnetwork.js',
  ['goog.net.tmpnetwork'],
  ['goog.Uri', 'goog.dom.safe', 'goog.net.ChannelDebug'],
  { lang: 'es6' }
);
goog.addDependency(
  'net/ipaddress.js',
...
goog.addDependency(
  ...
  ['goog.net.CorsXmlHttpFactory', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'net/browserchannelserverreachability.js',
  ['goog.net.browserchannelinternal.ServerReachability'],
  [],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.math.Integer', 'goog.testing.testSuite', 'goog.net.ipaddress'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'net/browserchannelstats.js',
  ['goog.net.browserchannelinternal.stats'],
  ['goog.events.Event', 'goog.events.EventTarget'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  'module/moduleloadfailuretype.js',
  ['goog.module.ModuleLoadFailureType'],
  [],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.reflectTest'],
  ['goog.object', 'goog.reflect', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'tweak/tweak.js',
...
goog.addDependency('editor/tablerow.js', ['goog.editor.TableRow'], [], {
  lang: 'es6',
  module: 'goog',
});
goog.addDependency(
...
goog.addDependency('editor/tablecell.js', ['goog.editor.TableCell'], [], {
  lang: 'es6',
  module: 'goog',
});
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.editor.Command', 'goog.editor.Link', 'goog.editor.Plugin'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.editor.plugins.UndoRedoState', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'editor/plugin.js',
  ['goog.editor.Plugin'],
  ['goog.editor.Field', 'goog.editor.PluginImpl'],
  {}
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.html.SafeHtmlFormatter'],
  ['goog.html.SafeHtml', 'goog.asserts', 'goog.string', 'goog.dom.tags'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'html/sanitizer/htmlsanitizer_unified_test.js',
  ['goog.html.HtmlSanitizerUnifiedTest'],
  [
    'goog.html.SafeHtml',
    'goog.html.sanitizer.HtmlSanitizer.Builder',
    'goog.testing.testSuite',
    'goog.html.htmlTestVectors',
    'goog.userAgent',
  ],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'html/sanitizer/html_test_vectors.js',
  ['goog.html.htmlTestVectors'],
  [],
  { lang: 'es5' }
);
...
goog.addDependency(
  'html/sanitizer/safedomtreeprocessor.js',
  ['goog.html.sanitizer.SafeDomTreeProcessor'],
  [
    'goog.string.Const',
    'goog.html.sanitizer.ElementWeakMap',
    'goog.log.Logger',
    'goog.dom.NodeType',
    'goog.dom.TagName',
    'goog.dom',
...
goog.addDependency(
  'html/sanitizer/safedomtreeprocessor_test.js',
  ['goog.html.sanitizer.SafeDomTreeProcessorTest'],
  [
    'goog.html.sanitizer.SafeDomTreeProcessor',
    'goog.html.sanitizer.noclobber',
    'goog.testing.testSuite',
...
goog.addDependency(
  'html/sanitizer/elementweakmap_test.js',
  ['goog.html.sanitizer.ElementWeakMapTest'],
  [
    'goog.html.sanitizer.ElementWeakMap',
    'goog.testing.testSuite',
    'goog.userAgent',
...
goog.addDependency(
  ...
  [
    ...
    'goog.userAgent',
    'goog.html.sanitizer.attributeallowlists',
  ],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'html/sanitizer/noclobber.js',
  ['goog.html.sanitizer.noclobber'],
  ['goog.dom.NodeType', 'goog.asserts', 'goog.userAgent.product'],
  { lang: 'es5', module: 'goog' }
);
goog.addDependency(
  'html/sanitizer/csspropertysanitizer.js',
  ['goog.html.sanitizer.CssPropertySanitizer'],
  ['goog.html.SafeUrl', 'goog.asserts', 'goog.object', 'goog.string'],
  { module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'html/sanitizer/csspropertysanitizer_test.js',
  ['goog.html.sanitizer.CssPropertySanitizerTest'],
  [
    'goog.html.sanitizer.CssPropertySanitizer',
    'goog.html.SafeUrl',
    'goog.functions',
...
goog.addDependency(
  'html/sanitizer/attributeallowlists.js',
  ['goog.html.sanitizer.attributeallowlists'],
  [],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'html/sanitizer/elementweakmap.js',
  ['goog.html.sanitizer.ElementWeakMap'],
  ['goog.html.sanitizer.noclobber'],
  { module: 'goog' }
);
goog.addDependency(
  'html/sanitizer/noclobber_test.js',
  ['goog.html.sanitizer.noclobberTest'],
  [
    'goog.dom.NodeType',
    'goog.testing.PropertyReplacer',
    'goog.html.sanitizer.noclobber',
...
goog.addDependency(
  'html/textextractor_test.js',
  ['goog.html.textExtractorTest'],
  ['goog.testing.testSuite', 'goog.html.textExtractor'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  'html/trustedtypes_test.js',
  ['goog.html.trustedtypesTest'],
  [
    'goog.testing.PropertyReplacer',
    'goog.testing.recordFunction',
    'goog.testing.testSuite',
...
goog.addDependency(
  'html/cssspecificity_test.js',
  ['goog.html.CssSpecificityTest'],
  [
    'goog.html.CssSpecificity',
    'goog.testing.testSuite',
    'goog.userAgent',
...
goog.addDependency(
  'delegate/delegateregistry.js',
  ['goog.delegate.DelegateRegistry'],
  ['goog.asserts', 'goog.array', 'goog.debug'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'delegate/delegateregistry_test.js',
  ['goog.delegate.DelegateRegistryTest'],
  ['goog.delegate.DelegateRegistry', 'goog.testing.testSuite', 'goog.array'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'delegate/delegates_test.js',
  ['goog.delegate.delegatesTest'],
  [
    'goog.delegate.delegates',
    'goog.testing.recordFunction',
    'goog.testing.testSuite',
  ],
  { lang: 'es6', module: 'goog' }
...
goog.addDependency(
  ...
  ['goog.crypt.baseN', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.testing.TestCase', 'goog.crypt.hash32', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'crypt/aes_test.js',
  ['goog.crypt.AesTest'],
  ['goog.crypt.Aes', 'goog.crypt', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency(
  ...
  ['goog.crypt.base64', 'goog.crypt', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'crypt/md5_test.js',
...
goog.addDependency(
  'crypt/cbc_test.js',
  ['goog.crypt.CbcTest'],
  ['goog.crypt.Aes', 'goog.crypt.Cbc', 'goog.crypt', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'crypt/hmac_test.js',
...
goog.addDependency(
  'crypt/ctr_test.js',
  ['goog.crypt.CtrTest'],
  ['goog.crypt.Aes', 'goog.crypt.Ctr', 'goog.crypt', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'crypt/sha512_256.js',
...
goog.addDependency(
  'crypt/cbc.js',
  ['goog.crypt.Cbc'],
  ['goog.array', 'goog.asserts', 'goog.crypt', 'goog.crypt.BlockCipher'],
  {}
);
goog.addDependency(
  'crypt/crypt_test.js',
  ['goog.cryptTest'],
  ['goog.crypt', 'goog.string', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'crypt/arc4_test.js',
  ['goog.crypt.Arc4Test'],
  ['goog.crypt.Arc4', 'goog.array', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
...
goog.addDependency(
  ...
  ['goog.spell.SpellCheck', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'color/alpha_test.js',
  ['goog.color.alphaTest'],
  ['goog.color.alpha', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'color/color_test.js',
  ['goog.colorTest'],
  ['goog.color', 'goog.color.names', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
...
goog.addDependency('transpile.js', [], [], { lang: 'es5' });
goog.addDependency(
...
goog.addDependency(
  'mochikit/async/deferred_async_test.js',
  ['goog.async.deferredAsyncTest'],
  ['goog.async.Deferred', 'goog.testing.testSuite'],
  { lang: 'es6', module: 'goog' }
);
goog.addDependency(
  'mochikit/async/deferred_test.js',
  ['goog.async.deferredTest'],
  [
    'goog.async.Deferred',
    'goog.Promise',
    'goog.Thenable',
...
goog.addDependency(
  'mochikit/async/deferredlist_test.js',
  ['goog.async.deferredListTest'],
  [
    'goog.async.Deferred',
    'goog.async.DeferredList',
    'goog.array',
